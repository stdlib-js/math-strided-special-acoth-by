...
```javascript
import acothBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-acoth-by@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-strided-special-acoth-by/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-strided-special-acoth-by/actions/workflows/test.yml?query=branch:v0.2.2
