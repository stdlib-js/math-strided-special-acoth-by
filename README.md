...
```javascript
import acothBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-acoth-by@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-strided-special-acoth-by/tags). For example,

```javascript
import acothBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-acoth-by@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-acoth-by@deno/mod.js';
```
